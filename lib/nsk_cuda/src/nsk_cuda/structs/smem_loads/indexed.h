...
__device__ void smem_cpasync_wmma_loader<warp_rows_per_m, warp_cols_per_n, T>::load_A_indexed(T *x_smem, const float *embedding_book, const float *idxs, int next_tile, int M, int N) {
...
template<int warp_rows_per_m, int warp_cols_per_n, typename T>
__device__ void smem_cpasync_wmma_loader<warp_rows_per_m, warp_cols_per_n, T>::load_B_indexed(T *x_smem, const float *embedding_book, const float *idxs, int next_tile, int M, int N) {
