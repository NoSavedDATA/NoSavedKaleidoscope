...
__device__ void blocking_tiled_wmma_i8_16x16x16_mma(int *out,
                                              ...
                                              const int M, const int N, const int K, const int WMMA_M, const int WMMA_N)
{
    ...
    {   
        ...
        wmma_i8_m16n16k16_mma<warp_rows_per_m, warp_cols_per_n, T>(out, wmma_idx, smem_loader, x_smem, w_smem,
