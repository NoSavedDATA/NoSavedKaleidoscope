...
__device__ void blocking_tiled_wmma_i8_16x16x16_dw(i8_wmma_frags<warp_rows_per_m, warp_cols_per_n, int8_t> &frag_loader,
...
{
    smem_loader.load_A_transposed(x_smem, x, 0, K, M);
