...
void MaxPool2dCPP::SetDescriptors(int H, int W, int B, int C, DT_tensor *tensor)
{
  this->H = H;
  this->W = W;
  this->B = B;
...
float *MaxPool2dCPP::Forward(DT_tensor *tensor, int H, int W, int B, int C, int thread_id)
{
