...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "Conv2d", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"tensor_Create", "tensor_Load", "tensor_Store", "tensor_opa", "gpu", "tensor_gpuw", "cpu", "cpu_idx", "randu_like", "write_zerosw", "tensor_view", "NewVecToTensor", "tensor_CalculateIdx", "zeros_like", "tensor_print", 
		"ConcatScopeStr", 
