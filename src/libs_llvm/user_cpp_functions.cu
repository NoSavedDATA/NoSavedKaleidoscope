...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "Conv2d", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"str_vec_Create", "str_vec_Load", "str_vec_Store", "PrintStrVec", "LenStrVec", "ShuffleStrVec", "_glob_b_", "IndexStrVec", "str_vec_Idx", "str_vec_CalculateIdx", "str_vec_print", 
		"AdamW", 
		...
		"tensor_Create", "tensor_Load", "tensor_Store", "tensor_opa", "gpu", "tensor_gpuw", "cpu", "cpu_idx", "randu_like", "write_zerosw", "tensor_view", "NewVecToTensor", "tensor_CalculateIdx", "zeros_like", 
		"ConcatScopeStr", "RemoveTensorScope", "RemoveTensorScopeAttrOnIndex", 
		...
		"float_vec_Create", "float_vec_Load", "float_vec_Store", "float_vec_Store_Idx", "float_vec_Mark", "PrintFloatVec", "zeros_vec", "ones_vec", "float_vec_Idx", "float_vec_CalculateIdx", "float_vec_first_nonzero", "float_vec_print", 
		...
		"save_img", 
		"OneCycleLR", 
		"MarkToSweep_Mark", "MarkToSweep_Unmark", 
		"save_as_bin", 
		"cross_entropy", "cross_entropy_idx", 
		"btc_mult", "btc_multT", 
		"PrintDims", "NewDimsOnIdx", "StoreDimsOnDemand", "CalculateIdxOffset", "tensor_shape", 
		"scope_struct_Create", "scope_struct_Copy", "scope_struct_Overwrite", "scope_struct_Dive", "set_scope_at_return", "set_scope_not_at_return", "set_scope_first_arg", "set_scope_scope", "set_scope_previous_scope", "set_scope_thread_id", "set_scope_has_grad", "set_scope_function_name", "get_scope_first_arg", "get_scope_scope", "get_scope_previous_scope", "get_scope_thread_id", "get_scope_has_grad", "scope_struct_Save_for_Async", "scope_struct_Load_for_Async", "scope_struct_Print", "scope_struct_Get_Async_Scope", "scope_struct_Alloc_MarkSweepMap", "scope_struct_Copy_MarkSweepMap", "tid", "scope_struct_Clean_Scope", "scope_struct_Delete", 
		"print_codegen", 
		"logE", "logE2", "clip", 
