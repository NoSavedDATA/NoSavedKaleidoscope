...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "Conv2d", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"float_vec_Create", "float_vec_Load", "float_vec_Store", "float_vec_Store_Idx", "float_vec_Mark", "PrintFloatVec", "arange_float", "zeros_vec", "ones_vec", "float_vec_Idx", "float_vec_CalculateIdx", "float_vec_first_nonzero", "float_vec_print", 
