...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"get_barrier", 
		"print", 
		"list_New", "list_append_int", "list_append_float", "list_append_bool", "list_append", "list_print", "tuple_print", "list_Create", "list_size", "list_CalculateIdx", "to_int", "to_float", "list_CalculateSliceIdx", "list_Slice", "assign_wise_list_Idx", "int_list_Store_Idx", "float_list_Store_Idx", "zip", "list_Idx", "tuple_Idx", 
		...
		"str_Create", "str_Store", "str_Copy", "str_CopyArg", "str_str_add", "str_int_add", "str_float_add", "int_str_add", "float_str_add", "str_bool_add", "bool_str_add", "PrintStr", "cat_str_float", "str_split_idx", "str_to_float", "str_Delete", "readline", 
