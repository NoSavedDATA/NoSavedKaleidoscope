...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"list_New", "list_append_int", "list_append_float", "list_append_bool", "list_append", "list_print", "tuple_print", "list_Create", "list_shuffle", "list_size", "list_as_float_vec", "list_CalculateIdx", "to_int", "to_float", "list_CalculateSliceIdx", "list_Slice", "assign_wise_list_Idx", "int_list_Store_Idx", "float_list_Store_Idx", "list_Store_Idx", "zip", "list_Idx", "tuple_Idx", 
		...
		"FirstArgOnDemand", 
		"objAttr_var_from_var", "objAttr_var_from_vec", "objAttr_vec_from_var", "objAttr_vec_from_vec", "append", "offset_object_ptr", "object_Attr_float", "object_Attr_int", "object_Load_float", "object_Load_int", "object_Load_slot", "tie_object_to_object", "object_Attr_on_Offset_float", "object_Attr_on_Offset_int", "object_Attr_on_Offset", "object_Load_on_Offset_float", "object_Load_on_Offset_int", "object_Load_on_Offset", "object_ptr_Load_on_Offset", "object_ptr_Attribute_object", 
		"min", "max", "logE2f", "roundE", "floorE", "logical_not", 
		"str_Create", "str_Store", "str_Copy", "str_CopyArg", "str_str_add", "str_int_add", "str_float_add", "int_str_add", "float_str_add", "str_bool_add", "bool_str_add", "PrintStr", "cat_str_float", "str_split_idx", "str_to_float", "str_str_different", "str_str_equal", "str_Delete", "readline", 
		...
		"float_vec_Create", "float_vec_Store_Idx", "arange_float", "zeros_float", "ones_float", "float_vec_Idx", "float_vec_CalculateIdx", "float_vec_first_nonzero", "float_vec_print", "float_vec_pow", "float_vec_sum", "float_vec_int_add", "float_vec_int_div", "float_vec_float_vec_add", "float_vec_float_vec_sub", "float_vec_Split_Parallel", "float_vec_Split_Strided_Parallel", "float_vec_size", 
		"CreateNotesVector", "Dispose_NotesVector", "Add_To_NotesVector_float", "Add_To_NotesVector_int", "Add_To_NotesVector_str", 
		"RandomStrOnDemand", "GetEmptyChar", "FreeCharFromFunc", "FreeChar", "CopyString", "ConcatStr", "ConcatStrFreeLeft", "ConcatFloatToStr", "ConcatNumToStrFree", 
		"scope_struct_Alloc_GC", 
		"allocate_void", 
		"int_vec_Create", "int_vec_Store_Idx", "arange_int", "zeros_int", "rand_int_vec", "ones_int", "int_vec_Idx_num", "int_vec_Idx", "int_vec_CalculateIdx", "int_vec_CalculateSliceIdx", "int_vec_Slice", "int_vec_first_nonzero", "int_vec_print", "int_vec_Split_Parallel", "int_vec_Split_Strided_Parallel", "int_vec_size", 
		"scope_struct_spec", "set_scope_line", "scope_struct_Create", "scope_struct_Copy", "scope_struct_Overwrite", "scope_struct_Dive", "set_scope_first_arg", "set_scope_scope", "set_scope_thread_id", "set_scope_has_grad", "set_scope_function_name", "get_scope_first_arg", "get_scope_scope", "get_scope_thread_id", "get_scope_has_grad", "scope_struct_Reset_Threads", "scope_struct_Increment_Thread", "scope_struct_Print", "set_scope_object", "get_scope_object", "scope_struct_Save_for_Async", "scope_struct_Load_for_Async", "scope_struct_Store_Asyncs_Count", "scope_struct_Get_Async_Scope", "scope_struct_Copy_MarkSweepMap", "scope_struct_Clear_GC_Root", "scope_struct_Add_GC_Root", "scope_struct_Sweep", "scope_struct_Clean_Scope", "scope_struct_Delete", 
