...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"array_Create", "array_size", "array_print_int", "arange_int", "zeros_int", "rand_int_vec", "ones_int", "array_print_float", "arange_float", "zeros_float", "ones_float", "array_Split_Parallel", 
		"allocate_void", 
