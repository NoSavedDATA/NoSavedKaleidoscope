...
void set_user_functions() {
    ...
    user_cpp_functions = {"Linear", "tensor_view", "tensor_clip", "tensor_argmax", "tensor_tmax", "tensor_onehot", "tensor_shape", "tensor_permute", "tensor_cpu", "printtt",
		...
		"array_Create", "array_size", "array_print_int", "arange_int", "rand_int_vec", "ones_int", "array_print_float", "arange_float", "ones_float", "array_Split_Parallel", 
		"allocate_void", 
		"int_vec_Create", "nsk_vec_size", "int_vec_CalculateSliceIdx", "int_vec_Slice", "int_vec_first_nonzero", "int_vec_print", "int_vec_Split_Parallel", "int_vec_Split_Strided_Parallel", "int_vec_size", 
		"scope_struct_spec", "set_scope_line", "scope_struct_CreateFirst", "scope_struct_Create", "scope_struct_Copy", "scope_struct_Overwrite", "set_scope_thread_id", "get_scope_thread_id", "scope_struct_Reset_Threads", "scope_struct_Increment_Thread", "scope_struct_Print", "set_scope_object", "get_scope_object", "scope_struct_Save_for_Async", "scope_struct_Load_for_Async", "scope_struct_Store_Asyncs_Count", "scope_struct_Get_Async_Scope", "scope_struct_Copy_MarkSweepMap", "scope_struct_Clear_GC_Root", "scope_struct_Add_GC_Root", "scope_struct_Sweep", "scope_struct_Clean_Scope", "scope_struct_Delete", 
