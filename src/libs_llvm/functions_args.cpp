...
void set_functions_args_type() {
		...
		Function_Arg_DataTypes["SplitString"]["0"] = Data_Tree("Scope_Struct");
		Function_Arg_DataTypes["SplitString"]["1"] = Data_Tree("str");
		Function_Arg_DataTypes["SplitString"]["2"] = Data_Tree("str");
