...
void set_functions_return_type() {
  ...
  functions_return_type = {{"gelu", "tensor"}, {"sigmoid", "tensor"}, {"_tanh", "tensor"}, {"relu", "tensor"}, {"softmax", "tensor"},
						...
						{"tensor_Create", "tensor"}, {"tensor_Load", "tensor"}, {"gpu", "tensor"}, {"randu_like", "tensor"}, {"tensor_view", "tensor"}, {"zeros_like", "tensor"}, 
						{"RandomCrop", "tensor"}, {"RandomHorizontalFlip", "tensor"}, {"NormalizeImg", "tensor"}, {"Jitter", "tensor"}, 
						{"FirstArgOnDemand", "str"}, 
						{"LenStrVec", "int"}, {"IndexStrVec", "str"}, {"str_vec_Idx", "str"}, 
						...
						{"CreateNotesVector", "list"}, {"Add_Float_To_NotesVector", "list"}, {"Add_Int_To_NotesVector", "list"}, {"Add_String_To_NotesVector", "list"}, 
