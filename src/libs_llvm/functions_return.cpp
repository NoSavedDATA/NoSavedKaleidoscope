...
void set_functions_return_type() {
  ...
  functions_return_type = {{"gelu", "tensor"}, {"sigmoid", "tensor"}, {"_tanh", "tensor"}, {"relu", "tensor"}, {"softmax", "tensor"} , {"_glob_b_", "str_vec"}, {"glob", "str_vec"},
						...
						{"scope_struct_spec", "float"}, {"scope_struct_Create", ""}, {"scope_struct_Copy", ""}, {"scope_struct_Overwrite", ""}, {"scope_struct_Dive", ""}, {"get_scope_first_arg", "str"}, {"get_scope_scope", "str"}, {"get_scope_thread_id", "int"}, {"get_scope_has_grad", "int"}, {"scope_struct_Reset_Threads", "float"}, {"scope_struct_Increment_Thread", "float"}, {"scope_struct_Load_for_Async", ""}, 
						...
						{"list_New", "list"}, {"list_append", "float"}, {"list_print", "float"}, {"tuple_print", "float"}, {"list_Create", "list"}, {"list_size", "int"}, {"list_CalculateIdx", "int"}, {"to_int", "int"}, {"to_float", "float"}, {"list_CalculateSliceIdx", ""}, {"list_Slice", "list"}, {"int_list_Store_Idx", "float"}, {"float_list_Store_Idx", "float"}, {"zip", "list"}, 

	};

	functions_return_data_type = {						{"read_float", Data_Tree("float")}, {"float_to_str", Data_Tree("str")}, 
						{"RandomStrOnDemand", Data_Tree("str")}, {"GetEmptyChar", Data_Tree("str")}, {"CopyString", Data_Tree("str")}, {"ConcatStr", Data_Tree("str")}, {"ConcatStrFreeLeft", Data_Tree("str")}, {"ConcatFloatToStr", Data_Tree("str")}, {"ConcatNumToStrFree", Data_Tree("str")}, 
						...
						{"append", Data_Tree("float")}, {"object_Load_float", Data_Tree("float")}, {"object_Load_int", Data_Tree("int")}, {"object_Load_on_Offset_float", Data_Tree("float")}, {"object_Load_on_Offset_int", Data_Tree("int")}, 
						...
						{"list_New", Data_Tree("list")}, {"list_append", Data_Tree("float")}, {"list_print", Data_Tree("float")}, {"tuple_print", Data_Tree("float")}, {"list_Create", Data_Tree("list")}, {"list_size", Data_Tree("int")}, {"list_CalculateIdx", Data_Tree("int")}, {"to_int", Data_Tree("int")}, {"to_float", Data_Tree("float")}, {"list_CalculateSliceIdx", Data_Tree("")}, {"list_Slice", Data_Tree("list")}, {"int_list_Store_Idx", Data_Tree("float")}, {"float_list_Store_Idx", Data_Tree("float")}, {"zip", Data_Tree("list")}, 
