...
void set_functions_return_type() {
  ...
  functions_return_type = {{"gelu", "tensor"}, {"sigmoid", "tensor"}, {"_tanh", "tensor"}, {"relu", "tensor"}, {"softmax", "tensor"},
						...
						{"repeat_interleave", "tensor"}, {"mean_tensor", "tensor"}, {"tensor_mean", "tensor"}, {"sum", "tensor"}, {"prod", "tensor"}, {"gather", "tensor"}, 
						...
						{"int_vec_Load", "int_vec"}, {"int_vec_Store", "int"}, {"int_vec_Store_Idx", "int"}, {"arange_int", "int_vec"}, {"zeros_int", "int_vec"}, {"ones_int", "int_vec"}, {"int_vec_Idx", "int"}, {"int_vec_Idx_num", "int"}, {"int_vec_CalculateIdx", "int"}, {"int_vec_CalculateSliceIdx", "int_vec"}, {"int_vec_Slice", "int_vec"}, {"int_vec_first_nonzero", "int"}, {"int_vec_print", "int"}, {"int_vec_Split_Parallel", "int_vec"}, {"int_vec_Split_Strided_Parallel", "int_vec"}, {"int_vec_size", "int"}, 
