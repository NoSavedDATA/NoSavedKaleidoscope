...
template<int WMMA_T>
void blocking_mma_i8(const int8_t *x, const int8_t *w, float *o, int M, int N, int K, cudaStream_t stream)
{
...
template void blocking_mma_i8<16>(const int8_t*, const int8_t*, float*, int, int, int, cudaStream_t);